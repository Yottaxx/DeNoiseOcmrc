...
class ClassificationEvaluator:
    ...
    def evaluate(self, y_true, y_pred):
        ...
        results = {}
        results["micro_accuracy"] = float("{:.2f}".format(micro_accuracy*100)) #int(100 * micro_accuracy) / 100
        ...
        results["macro_accuracy"] = float("{:.2f}".format(macro_accuracy*100)) #int(100 * macro_accuracy) / 100
